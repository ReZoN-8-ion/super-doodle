...
export function demonstrateN9ml() {
  ...
  console.log(
    `  Vision→NLP: ${realtimeVision.architecture.type}(${realtimeVision.quantization.bits}bit) → ${remountedTensor.architecture.type}(${remountedTensor.quantization.bits}bit)`,
  );
